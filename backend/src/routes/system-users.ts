...
const createUserSchema = z.object({
  ...
  role: z.enum(['admin', 'manager', 'sales', 'operations', 'operations_control', 'operations_manager']),
...
const updateUserSchema = z.object({
  ...
  phone: z.string().optional().nullable(),
  role: z.enum(['admin', 'manager', 'sales', 'operations', 'operations_control', 'operations_manager']).optional(),
...
const MANAGED_ROLES = ['admin', 'manager', 'sales', 'operations', 'operations_control', 'operations_manager'] as const;
