...
export const createInstructorSchema = z.object({
  ...
  rateSupport: z.number().nonnegative().optional().nullable(),
...
export const createCycleSchema = z.object({
  ...
  primaryInstructorId: z.string().optional().nullable(),
  instructorTotalBudget: z.number().nonnegative().optional().nullable(),
...
export const createMeetingSchema = z.object({
  ...
  instructorRole: z.enum(['primary', 'support']).optional().nullable(),
